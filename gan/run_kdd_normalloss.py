...
import importlib
import sys
import gan.kdd_utilities_normalloss as network
...
def train_and_test(nb_epochs, weight, method, degree, random_seed):
    ...
    with sv.managed_session() as sess:
        ...
        # res.to_csv('bigan_kdd_scores_normalloss.csv')

        res.to_csv('/Users/oguzkaplan/Documents/repo/thesis/notebooks/gan_kdd_scores_normalloss.csv')
