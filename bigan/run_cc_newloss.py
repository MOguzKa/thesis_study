...
import importlib
import sys
import bigan.cc_utilities_newloss as network
...
def create_logdir(method, weight, rd):
    ...
    return "bigan/train_logs/cc_newloss/{}/{}/{}".format(weight, method, rd)
...
#
            ...
            print("Epoch %d | time = %.4fs | loss gen = %.4f | loss gen1 = %.4f| loss enc = %.4f | loss dis = %.4f "
        ...
        #res.to_csv('/Users/oguzkaplan/Documents/repo/thesis/notebooks/bigan_cc_scores_newloss_method1_corr_32.csv')
