...
import importlib
import sys
import bigan.kdd_utilities_newloss as network
...
def create_logdir(method, weight, rd):
    ...
    return "bigan/train_logs/kdd_newloss/{}/{}/{}".format(weight, method, rd)
...
def train_and_test(nb_epochs, weight, method, degree, random_seed):
    ...
    with tf.name_scope('Testing'):
        ...
        with tf.variable_scope('Score'):
            list_scores = (1 - weight) * gen_score + weight * dis_score # bastaki 0 carpanini kaldir ve dis scoredaki 1 yerine weight yaz
